...
class TestAccountMoveDeliveredAmount(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super(TestAccountMoveDeliveredAmount, cls).setUpClass()
    ...
    def test_account_move_delivered_amount_without_tax(self):
    ...
    def test_account_move_delivered_amount_with_tax(self):
